...
class Restaurante:
    ...
    @property
    def ativo(self):
        return 'Disponível' if self._ativo else 'Indisponível' 
    ...
    def receber_avaliacao(self, cliente, nota):
        if  0 < nota <= 5:
            ...
            return "Nota precisa ser de 0 até 5"
    @property
    ...
    def exibir_cardapio(self):
        ...
        for i, item in enumerate(self._cardapio, start=1):
            ...
            if hasattr(item, 'descricao'):
                mensagem_prato = f'{i}. Nome: {item._nome} | Preco: R${item._preco} | Descricão: {item.descricao}'
